...
exports.createCourse = (req, res) => {
  ...
  const sql = 'INSERT INTO courses (code, name, description) VALUES (?, ?, ?)';
  db.query(sql, [code, name, description || null], (err, result) => {
    if (err) {
...
exports.updateCourse = (req, res) => {
  ...
  db.query('UPDATE courses SET name=?, description=? WHERE id=?',
